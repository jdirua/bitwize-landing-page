...
import { FaCode, FaServer, FaShoppingCart, FaReact, FaNetworkWired } from 'react-icons/fa';
...
const CapacitorIcon = ({ size, className }) => (
  <svg viewBox="0 0 24 24" style={{ width: size, height: size }} className={className} fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 12H8"/>
    <path d="M16 12H20"/>
    <path d="M8 5V19"/>
    <path d="M16 5V19"/>
...
const ResistorIcon = ({ size, className }) => (
  <svg viewBox="0 0 24 24" style={{ width: size, height: size }} className={className} fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 12h3l2-4 4 8 4-8 2 4h3"/>
  </svg>
);

const DiodeIcon = ({ size, className }) => (
  <svg viewBox="0 0 24 24" style={{ width: size, height: size }} className={className} fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 12h10" />
...
const TransistorIcon = ({ size, className }) => (
  <svg viewBox="0 0 24 24" style={{ width: size, height: size }} className={className} fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
